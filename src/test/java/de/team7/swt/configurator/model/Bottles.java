...
public class Bottles implements Streamable<Bottle> {
    ...
    public static Bottle create05Brown() {
        return new Bottle(BOTTLE_05_BROWN_ID, "0.5l - Brown Glass", Money.of(0.70, EURO), URI.create("http://localhost:8080/05-brown.png"), BottleSize.NORMAL, BottleColor.BROWN);
    }

    public static Bottle create033Green() {
        return new Bottle(BOTTLE_033_GREEN_ID, "0.33l - Green Glass", Money.of(0.59, EURO), URI.create("http://localhost:8080/033-green.png"), BottleSize.SMALL, BottleColor.GREEN);
    }
