...
/**
 * Simple extension of {@link Persistable} which assumes the implementing entity {@link #isNew()} in case {@link
 * #getId()} is not set (yet).
 *
...
public interface Identifiable<ID extends Identifier> extends Persistable<ID> {
    ...
    /**
     * {@inheritDoc} Must be {@link Transient} in order to ensure that no JPA provider complains because of a missing
     * setter.
     *
